...
const lecturerNav = [
  { title: 'My Schedule', link: '/lecturerinfo', Icon: CalendarDays },
  { title: 'Alerts', link: '/lectureralerts', Icon: BellRing },
];
...
const LecturerSidebar = ({
  ...
  // Desktop logs out straight away; mobile opens the confirm modal first.
  ...
  return (
    <aside className="sidebar lecturer-sidebar flex shrink-0 flex-col bg-white">
      ...
      <nav className="px-3 mt-2 flex-1">
        ...
        <ul className="space-y-1">
          {lecturerNav.map(({ title, link, Icon }) => {
      ...
      <div className="px-5 pb-6 pt-5 space-y-3">
        ...
        <div className="rounded-2xl bg-b-blue text-white p-4">
          ...
          <p className="text-[11px] text-white/70 mt-1 leading-snug">
            Export your teaching schedule as a PDF or image from the Export
            button.
          </p>
        </div>
      </div>

      {/* Mobile foot: SMS bell + profile avatar each open a modal on the rail. */}
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1 leading-tight">
                  <p className="truncate text-base font-semibold text-b-blue">
                    {name ? name.toUpperCase() : 'Lecturer'}
                  </p>
